        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>客户信息管理<small>>修改客户信息信息</small></h5>
                </div>
                    ...
                    <form class="form-horizontal formUpdate">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input name="comname" value="${customer.comname}" type="text"
                                           class="form-control input-sm">
                                </div>
                                <label class="col-sm-2 col-sm-offset-1 control-label">公司联系人</label>
                                <div class="col-sm-3">
                                    <input name="companyperson" value="${customer.companyperson}" type="text"
                                           class="form-control input-sm">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input name="comphone" value="${customer.comphone}" type="text"
                                           class="form-control input-sm">
                                </div>
                                <label class="col-sm-2  col-sm-offset-1 control-label">座机</label>
                                <div class="col-sm-3">
                                    <input name="camera" value="${customer.camera}" type="text"
                                           class="form-control input-sm">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="comaddress" value="${customer.comaddress}" type="text"
                                           class="form-control input-sm">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <a href="/customer/list?pageNum=${pageNum}  " class="btn btn-white"><i
