                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <select name="type" class="selectpicker form-control">
                            ...
                            <option
                                    <c:if test="${type==2}">selected</c:if> value="2">报销人
                            </option>
                        </select>
                    </div>
                ...
                <table class="table table-striped list-table">
                    ...
                    <c:forEach items="${list}" var="baoxiao">
                        <tr>
                            ...
                            <td>未付款</td>
                            <td>
                                <button type="button" data-bxid="${baoxiao.bxid}" class="btn btn-danger btn-xs btnPay">
                                    付款
                                </button>
                            </td>
                        </tr>
    ...
    $(document).ready(function () {
        ...
        $('.btnPay').click(function () {
            ...
            swal({
                ...
                $.post("/baoxiao/update", "bxid=" + bxid + "&bxstatus=3", function (result) {
                    if (result == 'true') {
                        swal({
                            title: "付款成功！",
