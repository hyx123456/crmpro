        ...
        <div class="ibox-content">
            <form action="/function/list" method="post">
                <div class="row">
                    ...
                    <div class="col-sm-2 text-right">
                        <a href="/save-function.jsp" class="btn btn-sm btn-primary" type="button"><i
                                class="fa fa-plus-circle"></i>添加功能</a>
                    </div>
                </div>
            </form>
            ...
            <div class="table-responsive">
                <table class="table table-striped list-table">
                    ...
                    <c:forEach items="${list}" var="function" varStatus="i">
                        <tr>
                            <td><input type="checkbox" value="${function.id}" data-num="${i.count}"></td>
                            <td>${i.count}</td>
                            ...
                            <td>
                                ...
                                <c:if test="${function.level=='暂缓'}"> 暂缓</c:if>
                            </td>
                            ...
                            <td>
                                <a href="/function/info?id=${function.id}&pageNum=${page.pageNum}"><i
                                        class="glyphicon glyphicon-eye-open  text-navy"></i></a>
                                <a href="/function/toupdate?id=${function.id}&pageNum=${page.pageNum}"><i
                                        class="glyphicon glyphicon-edit  text-navy"></i></a>
                                <a href="javascript:void(0)" class="btndel" id="${function.id}" data-num="${i.count}"><i
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7 text-right">
                        <div class="btn-group">
                            ...
                            <a href="/function/list?pageNum=${page.pageNum-1}&type=${type}&keyword=${keyword}"
                            ...
                            <c:forEach begin="1" end="${page.pages}" varStatus="i">
                                <a href="/function/list?pageNum=${i.index}&type=${type}&keyword=${keyword}"
...
<script>
    $(document).ready(function () {
        ...
        function doRemove(ids, nums) {
            $.post("/function/remove", "ids=" + ids + "&nums=" + nums, function (result) {
                if (result == 'true') {
                    swal({
                        title: "删除成功！",
                        text: "删除成功，现在为您返回列表页",
