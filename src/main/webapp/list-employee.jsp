        ...
        <div class="ibox-content">
                ...
                <form action="/employee/list" method="get">
                    <div class="col-sm-2">
                        <select name="type" class="selectpicker form-control">
                            ...
                            <option
                                    <c:if test="${type==1}">selected</c:if> value="2">职位
                            </option>
                        </select>
                    </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped list-table">
                    ...
                    <tbody>
                    <c:forEach items="${list}" var="employee" varStatus="index">
                        <tr>
            ...
            <div class="row">
                ...
                <div class="col-sm-7 text-right">
                    <div class="btn-group">
                        ...
                        <a href="/employee/list?pageNum=${page.pageNum-1}&type=${type}&keyword=${keyword}"
                        ...
                        <c:forEach begin="1" end="${page.pages}" varStatus="i">
                            <a href="/employee/list?pageNum=${i.index}&type=${type}&keyword=${keyword}"
